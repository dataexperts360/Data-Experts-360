                            ...
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button asChild size="lg" className="bg-gradient-to-r from-primary to-accent hover:opacity-90">
                                        <Link href="/join/become-data-ambassador" className="flex items-center gap-2">
                                            Apply Now
                                            <ArrowRight className="w-4 h-4" />
                                        </Link>
                                    </Button>
                                    <Button asChild size="lg" variant="outline">
                                        <Link href="/join/data-ambassadors">Meet Our Ambassadors</Link>
                                    </Button>
                                </div>
                            </div>
                        </ScrollReveal>
                        ...
                        <ScrollReveal>
                            <div className="max-w-3xl mx-auto text-center p-12 rounded-3xl bg-gradient-to-br from-primary to-accent text-primary-foreground">
                                ...
                                <Button asChild size="lg" variant="secondary" className="bg-primary-foreground text-primary hover:bg-primary-foreground/90">
                                    <Link href="/join/become-data-ambassador">Apply Now</Link>
                                </Button>
                            </div>
                        </ScrollReveal>
                    </div>
